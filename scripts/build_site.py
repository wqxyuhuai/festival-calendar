...
def build_site(destination=ROOT / "_site"):
    ...
    snapshot = json.loads((ROOT / "proj-chinese-calendar/snapshot.json").read_text(encoding="utf-8"))
    ...
    shutil.copy2(ROOT / "proj-festivals/festival_extra.ics", destination / "festival_extra.ics")
    ...
    shutil.copy2(ROOT / "proj-chinese-calendar/daily.ics", destination / "chinese-calendar/daily.ics")
